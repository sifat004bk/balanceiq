# BalanceIQ - Core Business Idea

**Market:** Bangladesh
**Version:** 1.0 BD
**Date:** 2025-11-16
**Status:** Bangladesh Market Strategy
...
## Problem We Solve for Bangladesh Users
...
**Chat-Based Manual Entry (This is the Feature, Not a Bug)**
...
- US expects bank sync - our manual entry would be seen as inferior

---

## Key Differentiators for BD Market
...
- **Conversational AI**: First AI-powered expense tracker in Bangladesh
- **Multi-Input**: Text, voice, photo - flexibility for different situations
- **Cash-Friendly**: Built for cash/mobile money economy
- **Local Context**: Understands "bKash send", "Nagad cash-out", "rickshaw fare"
- **Bilingual**: Bangla and English (code-switching natural for urban BD)

---

## Target Users in Bangladesh
...
- Wants to save money but loses track mid-month
- Comfortable with apps but not financial experts
...
- Monitor savings for big purchases (phone, bike, flat)

**Secondary Segment: Young Professionals & Students**

- Age: 22-30
- Income: 20,000-50,000 BDT/month
- Wants to track expenses to stretch budget
- Heavy app users, early adopters
- Will use free tier, may upgrade for insights

**Tertiary Segment: Small Business Owners**

- Age: 30-50
- Income: Variable, 50K-200K BDT/month
...
- Ready to expand to India, Pakistan, Sri Lanka (similar markets)

---

**Next Steps:** See 02_revenue_model.md for pricing and monetization strategy.
